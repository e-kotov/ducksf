...
![](reference/figures/vis-test-total.png)

![](reference/figures/vis-test-sum.png)

As you can see from the figures, `ducksf` is much faster than than
[`areal::aw_interpolate()`](https://slu-openGIS.github.io/areal/reference/aw_interpolate.html)
(and
[`sf::st_interpolate_aw()`](https://r-spatial.github.io/sf/reference/interpolate_aw.html),
as it works the same way, but is functionally more limited), especially
for large datasets. It also uses less memory, which is crucial when
working with large spatial datasets. Even though there is a cost of
translating `sf` objects to DuckDB tables and back, the overall
...
[ducksf](https://github.com/e-kotov/ducksf) from
...
![](reference/figures/example-plot.png)

## Mask `{sf}` functions

[ducksf](https://github.com/e-kotov/ducksf) also provides a way to
**mask [sf](https://r-spatial.github.io/sf/) functions** so that they
dispatch to [ducksf](https://github.com/e-kotov/ducksf) instead of
[sf](https://r-spatial.github.io/sf/). This is useful if you want to use
[sf](https://r-spatial.github.io/sf/) functions with
[ducksf](https://github.com/e-kotov/ducksf) semantics without changing
your code too much. By default it is of course disabled, so you can use
[sf](https://r-spatial.github.io/sf/) functions as usual even if
[ducksf](https://github.com/e-kotov/ducksf) is loaded. The resulting
numbers will be insignificantly different from
[sf](https://r-spatial.github.io/sf/) results due to rounding errors,
