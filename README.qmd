...
::: {.callout-caution}
This package is not developed anymore, but you can access its lightning fast aerial-weighted interpolation in [`{duckspatial}`](https://cidree.github.io/duckspatial/) via [`duckspatial::ddbs_interpolate_aw()`](https://cidree.github.io/duckspatial/reference/ddbs_interpolate_aw.html) function.
:::
